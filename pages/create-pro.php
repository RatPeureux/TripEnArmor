        ...
        <div class="h-full flex flex-col items-center justify-center">
            <div class="relative w-full max-w-96 h-fit flex flex-col items-center justify-center sm:w-96 m-auto">
                ...
                <form class="bg-base200 w-full p-5 rounded-lg border-2 border-secondary" action="create-pro.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                    ...
                    <input class="p-2 bg-base100 w-full h-12 mb-1.5 rounded-lg" type="text" id="deno" name="deno" pattern="^?:(\w+|\w+[\.\-_]?\w+)+$" title="Saisir la dénomination sociale de l'entreprise" maxlength="100" required>
