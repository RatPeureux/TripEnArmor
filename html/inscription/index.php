    ...
    <body class="h-screen bg-white p-4 overflow-hidden">
        ...
        <div class="h-full flex flex-col items-center justify-center">
            <div class="relative w-full max-w-96 h-fit flex flex-col items-center justify-center sm:w-96 m-auto">
                ...
                <form class="bg-base100 w-full p-5 roundex-lg border-2 border-primary" action="" method="POST"
                    ...
                    <div class="flex flex-nowrap space-x-3 mb-1.5">
                        <div class="w-full">
                            ...
                            <input class="p-2 bg-white w-full h-12 roundex-lg" type="text" id="prenom" name="prenom"
                        ...
                        <div class="w-full">
                            ...
                            <input class="p-2 bg-white w-full h-12 roundex-lg" type="text" id="nom" name="nom"
...
<?php } elseif (!isset($_POST['num_tel'])) {
    ...
    <body class="h-screen bg-white pt-4 px-4 overflow-x-hidden">
        ...
        <div class="w-full max-w-96 h-fit flex flex-col items-end sm:w-96 m-auto">
            ...
            <form class="mb-4 bg-base100 w-full p-5 roundex-lg border-2 border-primary" action="" method="POST">
                ...
                <input class="p-2 bg-white w-full h-12 mb-1.5 roundex-lg" type="text" id="pseudo" name="pseudo"
