...
<body class="h-screen bg-white pt-4 px-4 overflow-x-hidden">
    ...
    <div class="w-full max-w-96 h-fit flex flex-col items-end sm:w-96 m-auto">
        ...
        <form class="mb-4 bg-base200 w-full p-5 rounded-lg border-2 border-primary" action="create-membre.php" method="post" enctype="multipart/form-data">
            ...
            <label class="text-small" for="pseudo">Pseudonyme<label class="text-rouge-logo"> *</label></label>
            ...
            <label class="text-small" for="adresse">Adresse postale<label class="text-rouge-logo"> *</label></label>
            ...
            <div class="flex flex-nowrap space-x-3 mb-1.5">
                <div class="w-28">
                    <label class="text-small" for="code">Code postal<label class="text-rouge-logo"> *</label></label>
                ...
                <div class="w-full">
                    <label class="text-small" for="ville">Ville<label class="text-rouge-logo"> *</label></label>
            ...
            <label class="text-small" for="num_tel">Téléphone<label class="text-rouge-logo"> *</label></label>
            <div class="w-full">
            ...
            <div class="mb-1.5 flex items-start">
                ...
                <label class="text-small" for="termes">J’accepte les <u class="cursor-pointer">conditions d'utilisation</u> et vous confirmez que vous avez lu notre <u class="cursor-pointer">Politique de confidentialité et d'utilisation des cookies</u>.<label class="text-rouge-logo"> *</label></label>
            </div>
