    ...
    <div class="h-full flex flex-col items-center justify-center">
        <div class="relative w-full max-w-96 h-fit flex flex-col items-center justify-center sm:w-96 m-auto">
            ...
            <form class="bg-base100 w-full p-5  border-2 border-secondary" action="" method="POST">
                ...
                <input class="p-2 bg-white w-full h-12 mb-1.5 " type="text" id="id" name="id"
                ...
                <div class="flex items-center flex-nowrap h-12 space-x-1.5">
                    <a
                        class="text-small text-center w-full text-wrap bg-transparent text-secondary underline  focus:scale-[0.97]">
                        Mot de passe oublié ?
                    </a>
