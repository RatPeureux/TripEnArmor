...
<body class="min-h-screen flex flex-col justify-between">
    ...
    <div class="self-center  flex justify-center w-full md:max-w-[1280px] p-2">
        <main class="grow gap-4 p-4 md:p-2 flex flex-col md:mx-10 md:">
            ...
            <p class="text-h2 underline">Préambule</p>
            <p>
            ...
            <p class="text-h2 underline">Facturation des Offres</p>
            ...
            <p class="text-h2 underline">Facturation des Options</p>
            ...
            <p class="text-h2 underline">Montants Prévisionnels</p>
            <p>
            ...
            <p class="text-h2 underline">Paiements</p>
            <p>
            ...
            <p class="text-h2 underline">Modifications des CGV</p>
            <p>
