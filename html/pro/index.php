        ...
        <div class="w-full grow tablette p-4 flex flex-col">
            ...
            if (!$toutesMesOffres) { ?>
                <div class="md:min-w-full flex flex-col justify-center gap-4">
                    ...
                    <!-- <?php echo "<p class='mt-4 font-bolx text-h2'>Créer votre toute première offre dès maintenant !</p>"; ?> -->
                    <div class="flex justify-center">
                        <a href="/pro/offre/creer" class="self-center w-full h-80 text-center font-bolx text-gray-500 py-2 px-4 roundex-lg inline-flex items-center justify-center border border-dashed border-gray-500 hover:border-primary hover:text-primary animate-scale
