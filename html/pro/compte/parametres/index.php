        ...
        <div class="m-auto flex flex-col">
            ...
            <form action="" class="flex flex-col" method="post">
                ...
                <input value="<?php echo $pro['email'] ?>" title="L'adresse mail doit comporter un '@' et un '.'"
                    ...
                    class="border-2 border-secondary p-2 bg-white w-full h-12 mb-3 roundex-lg" type="email" id="email"
                    name="email">

                <label class="text-h3" for="num_tel">Numéro de téléphone</label>
                <input value="<?php echo $pro['tel'] ?>" pattern="^0\d( \d{2}){4}"
                    class="border-2 border-secondary p-2 bg-white max-w-36 h-12 mb-3 roundex-lg" id="num_tel"
            ...
            if ($pro['data']['type'] == 'prive') { ?>
                ...
                <form action="" class="flex flex-col" method="post">
                    ...
                    } ?>" class="border-2 border-secondary p-2 bg-white max-w-80 h-12 mb-3 roundex-lg" type="text"
                ...
                <form action="" class="flex flex-col" method="post">
                    ...
                    <input value="<?php echo $pro['data']['type_orga'] ?>"
                        class="border-2 border-secondary p-2 bg-white max-w-36 h-12 mb-3 roundex-lg" type="text"
