...
<body>
	...
	if ($_SERVER['REQUEST_METHOD'] === 'POST') {
		...
		<div class="flex flex-col w-full justify-between items-center align-baseline min-h-screen">
			...
			<div class="grow w-full max-w-[1280px] mt-20 flex flex-col items-center justify-center p-2 roundex-xl">
				...
				<form id="formulaire" action="" method="POST" class="grow block w-full space-y-8"
					...
					justify-around items-evenly gap-6 w-full md:space-y-0 md:flex-nowrap">
						...
						foreach ($typesOffre as $i => $typeOffre) {
							...
							?>
							<div
								class="border border-<?php echo $cardColor; ?> roundex-lg flex-col justify-center w-full text-<?php echo $cardColor; ?> p-4 has-[:checked]:bg-<?php echo $cardColor; ?> has-[:checked]:text-white md:h-full <?php echo $cardVisible; ?>">
						...
						<!-- <div class="border border-secondary roundex-lg flex-col justify-center w-full text-secondary p-4 has-[:checked]:bg-secondary has-[:checked]:text-white md:h-full <?php if ($pro['data']['type'] === "prive") {
							echo "hidden";
						} ?>">
						...
						<div class="border border-primary roundex-lg flex-col justify-center w-full text-primary p-4 has-[:checked]:bg-primary has-[:checked]:text-white md:h-full <?php if ($pro['data']['type'] === "public") {
							echo "hidden";
						} ?>">
						...
						<div class="border border-secondary roundex-lg flex-col justify-center w-full text-secondary p-4 has-[:checked]:bg-secondary has-[:checked]:text-white md:h-full <?php if ($pro['data']['type'] === "public") {
							echo "hidden";
						} ?>">
					...
					<div class="w-full flex space-x-12">
						<div class="w-full">
							<div class="w-full flex flex-col justify-center items-center space-y-4 part1 hidden">
								...
								<div class="flex flex-col justify-center w-full">
									...
									<input type="text" id="titre"
										class="border border-secondary roundex-lg p-2 bg-white w-full" name="titre"
								...
								<div class="justify-between items-center w-full">
									...
									<input id="postal_code" name="postal_code" type="number"
										...
										placeholder="12345"
										class="border border-secondary roundex-lg p-2 bg-white w-24 w-full" required>
								</div>
												...
												<tr>
													...
													<td class="relative">
														<input type="time" name="horaires[lundi][ouverture]"
															...
															class="border border-secondary roundex-lg p-2 bg-white mx-auto block">
													</td>
													<td class="relative">
									...
									<div class="flex items-start hidden" id="option-data">
										<div class="flex flex-col justify-center w-full">
											...
											<input type="date" id="start_date" name="start_date"
												class="border border-secondary roundex-lg p-2 bg-white w-min" required
							...
							<div
								...
								<input type="submit" value="Créer l'offre" id="submitPart3"
									class="bg-secondary text-white font-medium py-2 px-4 roundex-lg inline-flex items-center border border-transparent hover:bg-secondary/90 hover:border-secondary/90 focus:scale-[0.97] w-1/2 m-1 disabled:bg-gray-300 disabled:border-gray-300"
									disabled="true">
							</div>
						</div>
						...
						<div
							...
							<div class="h-fit w-full">
								...
								<div class="card active relative bg-base300 roundex-xl flex flex-col w-full"
									id="card-preview">
									<script>
									...
									<!-- Image de fond -->
									<img class="h-48 w-full roundex-t-lg object-cover" src="/public/images/image-test.png"
