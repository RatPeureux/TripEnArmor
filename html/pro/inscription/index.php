    ...
    <body class="h-screen bg-white p-4 overflow-hidden">
        ...
        <div class="h-full flex flex-col items-center justify-center">
            <div class="relative w-full max-w-96 h-fit flex flex-col items-center justify-center sm:w-96 m-auto">
                ...
                <form class="bg-white w-full p-5 rounded-lg border-2 border-secondary" action="" method="POST"
                    ...
                    <select class="text-small mt-1.5 mb-3 bg-base100 p-1 rounded-lg" id="statut" name="statut"
                    ...
                    <input class="p-2 bg-base100 w-full h-12 mb-1.5 rounded-lg" type="mail" id="mail" name="mail"
                    ...
                    <div class="relative w-full">
                        ...
                        <input class="p-2 pr-12 bg-base100 w-full h-12 mb-1.5 rounded-lg" type="password" id="confMdp"
...
<?php } elseif (!isset($_POST['num_tel'])) {
    ...
    <body class="h-screen bg-white pt-4 px-4 overflow-x-hidden">
        ...
        <div class="w-full max-w-96 h-fit flex flex-col items-end sm:w-96 m-auto">
            ...
            <form class="mb-4 bg-white w-full p-5 rounded-lg border-2 border-secondary" action="" method="POST">
                ...
                <?php if ($statut == 'public') {
                    ...
                    <select class="text-small mt-1.5 mb-3 bg-base100 p-1 rounded-lg" id="type_orga" name="type_orga"
                ...
                <?php } else { ?>
                    ...
                    <input class="p-2 bg-base100 w-full h-12 mb-1.5 rounded-lg" id="num_siren" name="num_siren"
                ...
                <input class="p-2 bg-base100 w-full h-12 mb-1.5 rounded-lg" type="text" id="user_input_autocomplete_address"
                ...
                <input class="p-2 bg-base100 w-full h-12 mb-1.5 rounded-lg" type="text" id="complement" name="complement"
                ...
                <div class="flex flex-nowrap space-x-3 mb-1.5">
                    <div class="w-28">
                        ...
                        <input class="text-right p-2 bg-base100 w-28 h-12 rounded-lg" id="postal_code" name="postal_code"
                    ...
                    <div class="w-full">
                        ...
                        <input class="p-2 bg-base100 w-full h-12 rounded-lg" id="locality" name="locality"
                ...
                <div class="w-full flex flex-col">
                    ...
                    <input class="text-center p-2 bg-base100 w-36 h-12 mb-3 rounded-lg" id="num_tel" name="num_tel"
                        pattern="^0\d( \d{2}){4}"
