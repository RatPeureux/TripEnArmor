    ...
    <body class="h-screen bg-white p-4 overflow-hidden">
        ...
        <div class="h-full flex flex-col items-center justify-center">
            <div class="relative w-full max-w-96 h-fit flex flex-col items-center justify-center sm:w-96 m-auto">
                ...
                <form class="bg-base100 w-full p-5  border-2 border-secondary" action="" method="POST"
                    ...
                    <select class="text-small mt-1.5 mb-3 bg-white p-1 " id="statut" name="statut"
                        ...
                        <input class="p-2 bg-white w-full h-12 mb-1.5 " type="text" id="nom" name="nom"
...
<?php } elseif (!isset($_POST['num_tel'])) {
    ...
    <body class="h-screen bg-white pt-4 px-4 overflow-x-hidden">
        ...
        <div class="w-full max-w-96 h-fit flex flex-col items-end sm:w-96 m-auto">
            ...
            <form class="mb-4 bg-base100 w-full p-5  border-2 border-secondary" action="" method="POST">
                ...
                <?php if ($statut == 'public') {
                    ...
                    <select class="text-small mt-1.5 mb-3 bg-white p-1 " id="type_orga" name="type_orga"
                ...
                <?php } else { ?>
                    ...
                    <input class="p-2 bg-white w-full h-12 mb-1.5 " id="num_siren" name="num_siren"
                ...
                <?php if ($statut == "privé") { ?>
                    ...
                    <div class="group">
                        ...
                        <div id="iban-container" class="hidden">
                            ...
                            <input class="p-2 bg-white w-full h-12 mb-3 " type="text" id="iban" name="iban"
