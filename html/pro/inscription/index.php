    ...
    <body class="h-screen bg-white pt-4 px-4 overflow-x-hidden">
        ...
        <div class="w-full max-w-96 h-fit flex flex-col items-end sm:w-96 m-auto">
            ...
            <form class="mb-4 bg-white w-full p-5 border-2 border-secondary" action="" method="POST">
                <div class="mb-3">
                    <label class="text-sm" for="nom" id="nom">Je suis un organisme
                        <?php echo $statut ?></label>
                </div>

                <?php if ($statut == "privé") { ?>
                    <!-- Champ pour la dénomination sociale (en lecture seule) -->
                    <label class="text-sm" for="nom" id="nom">Dénomination sociale</label>
                    <input class="p-2 bg-base100 w-full h-12 mb-1.5" type="text" id="nom" name="nom"
                ...
                <?php } else { ?>
                    ...
                    <label class="text-sm" for="nom" id="nom">Nom de l'organisation</label>
                    <input class="p-2 bg-base100 w-full h-12 mb-1.5" type="text" id="nom" name="nom"
                ...
                <label class="text-sm" for="adresse">Adresse</label>
