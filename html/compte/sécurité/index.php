    ...
    <main class="md:w-full mt-0 m-auto max-w-[1280px] p-2">
        ...
        <div class="max-w-[44rem] m-auto flex flex-col">
            ...
            <div class="relative w-full">
                ...
                <input class="border-2 border-secondary p-2 bg-white w-full h-12 mb-3 rounded-lg" type="password" id="mdp" name="mdp" title="" pattern=".*[A-Z].*.*\d.*|.*\d.*.*[A-Z].*" minlength="8">
            ...
            <div class="relative w-full">
                ...
                <input class="border-2 border-secondary p-2 bg-white w-full h-12 mb-3 rounded-lg" type="password" id="newMdp" name="newMdp" title="" minlength="8">
            ...
            <div class="relative w-full">
                ...
                <input class="border-2 border-secondary p-2 bg-white w-full h-12 mb-3 rounded-lg" type="password" id="confNewMdp" name="confNewMdp" title="" minlength="8">
...
<script>
    ...
    function checkFields() {
        ...
        if (isMdpValid && isNewMdpValid && isConfNewMdpValid && mdp.value !== newMdp.value && newMdp.value === confNewMdp.value) {
            save.disabled = false;
