            ...
            <div class="flex flex-col md:mx-10 grow">
                ...
                <form action="/compte/parametres" class="flex flex-col" method="post">
                    ...
                    <input value="<?php echo $adresse['complement'] ?>"
                        class="border border-secondary text-sm p-2 bg-white w-full h-12 mb-3 " type="text"
                    ...
                    <div class="flex flex-nowrap space-x-3 mb-1.5">
                        <div class="w-32">
                            ...
                            <input id="postal_code" name="postal_code" value="<?php echo $adresse['code_postal'] ?>"
                                class="border border-secondary p-2 text-sm text-right bg-white max-w-32 h-12 mb-3 "
