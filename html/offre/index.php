    ...
    <main class="flex flex-col md:block md:mx-10 self-center rounded-lg md:p-2 max-w-[1280px]">
        <div class="flex md:gap-3">
            ...
            <div class="grow md:p-4 flex flex-col items-center md:gap-4">
                ...
                <div class="flex flex-col p-2 pt-4 gap-2">
                    ...
                    ?>
                    <!-- Description + avis -->
                    <div class="description-et-avis flex flex-col md:flex-row">
                        <!-- Partie description -->
                        <div class="partie-description flex flex-col w-full md:w-5/12">
                        ...
                        <div class="avis w-full md:w-7/12 px-2 py-3">
                            <!-- Horaire -->
                            <a href="" class="">
