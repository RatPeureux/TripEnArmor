                ...
                <div class="infos flex items-center justify-center gap-2 px-2 grow">
                    ...
                    <div class="description py-2 flex flex-col gap-2 justify-center self-stretch">
                        ...
                        <p class="overflow-hidden line-clamp-2 text-small">
                            Priscilla en salle, son mari Christophe chef de cuisine et toute l'équipe vous accueillent
                            dans leur restaurant, Ouvert depuis Janvier 2018, dans le quartier Historique De Lannion :"
                            Brélévenez"
                    ...
                    foreach ($toutesLesOffres as $offre) {
                        ...
                        <a href="/pages/go_to_details.php?offre_id=<?php echo $offre_id ?>">
                            <div class="card <?php if ($option)
                                echo 'active' ?> relative bg-base200 rounded-lg flex">
                                    <!-- Partie gauche -->
                                    ...
                                    <div class="self-stretch flex flex-col gap-2">
                                        ...
                                        <div class="flex justify-around self-stretch">
                                            ...
                                            <div
                                                ...
                                                <p class="text-small"><?php echo $prix_a_afficher ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
