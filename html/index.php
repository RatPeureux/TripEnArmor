...
<body class="flex flex-col">
    ...
    <!-- VERSION TELEPHONE -->
    <main class="phone md:hidden p-4 flex flex-col gap-4">
        ...
        <div class="card relative bg-base300 rounded-xl flex flex-col">
            ...
            <!-- Image de fond -->
            <img class="h-48 w-full rounded-t-lg object-cover" src="../public/images/image-test2.jpg" alt="Image promotionnelle de l'offre">
            <!-- Infos principales -->
            <div class="infos flex items-center justify-center gap-2 px-2 grow">
                <!-- Localisation -->
                <div class="localisation flex flex-col gap-2 flex-shrink-0 justify-center items-center">
    ...
    <main class="hidden md:block bg-base200 mx-10 self-center rounded-lg p-2 max-w-[1024px]">
        <div class="flex gap-3">
            ...
            <div class="tablette p-4 flex flex-col gap-4">
                ...
                <div class="card relative bg-base300 rounded-lg flex h-80">
                    <!-- Partie gauche -->
                    <div class="gauche grow relative shrink-0 basis-1/2 overflow-hidden">
                        <!-- En tête -->
                        <div class="en-tete absolute top-0 w-72 max-w-full bg-bgBlur/75 backdrop-blur left-1/2 -translate-x-1/2 rounded-b-lg">
