...
<div class="hidden md:hidden space-y-4 mr-6 mb-4 w-full" id="filter-section-tab">
    ...
    <div class="flex flex-col w-full border border-black p-3 gap-4">
        ...
        <div class="hidden flex items-center gap-4" id="developped-f7-tab">
            <div class="flex items-center gap-2">
                <input type="checkbox" class="mb-1" class="mb-1" id="gratuit-tab" name="gratuit-tab" />
                <label>Gratuite</label>
            </div>

            <div class="flex items-center gap-2">
                <input type="checkbox" class="mb-1" id="standard-tab" name="standard-tab" />
                <label>Standard</label>
            </div>

            <div class="flex items-center gap-2">
                <input type="checkbox" class="mb-1" id="premium-tab" name="premium-tab" />
                <label>Premium</label>
            </div>
        </div>
    </div>
