...
<div class="hidden md:hidden relative" id="sort-section-tab">
    <div class="absolute top-0 right-0 z-20 self-end bg-white border border-base200  shadow-md max-w-48 p-2 flex flex-col gap-4">
...
<div class="hidden md:hidden space-y-4 mr-6 mb-4 w-full" id="filter-section-tab">
    ...
    <div class="flex flex-col w-full bg-base100 border border-base200  p-3 gap-4">
        ...
        <div class="hidden flex flex-wrap items-center gap-4" id="developped-f3-tab">
            <div class="text-nowrap text-small flex items-center gap-2 w-full">
                ...
                <input id="localisation-tab" type="text" class="w-full border border-base300  p-1 focus:ring-0" />
            </div>
        </div>
    </div>
    <div class="flex flex-col w-full bg-base100 border border-base200  p-3 gap-4">
        ...
        <div class="hidden flex items-center" id="developped-f4-tab">
            ...
            <div class="flex items-center">
                <input id="min-note-tab" type="number" value="0" min="0" max="5" step="0.5" class="w-[44px] border border-base300  p-1 text-small text-right focus:ring-0" />
                &nbsp;
                <img src="/public/icones/egg-full.svg" class="mb-1" width="11">
            </div>
            <label class="text-small">&nbsp;et&nbsp;</label>
            <div class="flex items-center">
                <input id="max-note-tab" type="number" value="5" min="0" max="5" step="0.5" class="w-[44px] border border-base300  p-1 text-small text-right focus:ring-0" />
                &nbsp;
                <img src="/public/icones/egg-full.svg" class="mb-1" width="11">
            </div>
        </div>
    ...
    <div class="hidden flex flex-col w-full bg-base100 border border-base200  p-3 gap-4">
        ...
        <div class="hidden text-small flex items-center" id="developped-f5-tab">
            ...
            <input type="date" class="border border-base300  p-1 text-right mr-4" id="min-date-tab" name="min-date-tab">
            <label>&nbsp;au&nbsp;</label>
            <input type="date" class="border border-base300  p-1 text-right" id="max-date-tab" name="max-date-tab">
        </div>
    </div>
    <div class="flex flex-col w-full bg-base100 border border-base200  p-3 gap-4">
        ...
        <div class="hidden flex flex-wrap items-center justify-between gap-2" id="developped-f6-tab">
            <div class="flex items-center">
                ...
                <input id="min-price-tab" type="number" value="0" min="0" max="99" class="w-[44px] border border-base300  p-1 text-small text-right focus:ring-0" />
                <label class="text-small">&nbsp;€&nbsp;et&nbsp;</label>
                <input id="max-price-tab" type="number" value="<?php echo $prix_mini_max;?>" min="0" max="<?php echo $prix_mini_max;?>" class="w-[44px] border border-base300  p-1 text-small text-right focus:ring-0" />
