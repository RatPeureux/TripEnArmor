<form id="formulaire-signalement-<?php echo $id_avis ?>" class="z-30 p-5 bg-white border border-black flex flex-col">
    ...
    <!-- MOTIF -->
    <label for="motif" class="text-h4">Motif</label>
    <select required name="motif" id="motif" class="mb-5 border border-black text-h4 bg-transparent text-center" required>
    ...
    <label for="commentaire-signalement" class="text-h4">Commentaire</label>
    <textarea name="commentaire-signalement" id="commentaire-signalement" class="mb-5 w-[400px] h-[150px] border border-black"></textarea>
