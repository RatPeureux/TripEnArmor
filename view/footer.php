        ...
        <footer class="bg-secondary text-white p-8 pb-16 md:pb-8 text-sm">
            <div class="mx-auto flex flex-col justify-center items-center">
                <div class="hidden md:flex w-full items-center justify-between">
                    ...
                    <a href="/" class="underline hover:text-primary">Retourner au tableau de bord</a>
                </div>
                ...
                <div class="w-full flex flex-col gap-8 mt-4">
                    ...
                    <div class="w-full flex items-center justify-between flex-col md:flex-row gap-4">
                        <div class="hidden md:block">
                            ©<?php echo date("Y"); ?> <a href="/pro/TripEnArvor" class="underline hover:text-primary">TripEnArvor</a>,
                ...
                <div class="w-full flex flex-col gap-8 mt-4">
                    <div class="w-full flex items-center justify-between flex-col md:flex-row gap-4">
                        <div class="hidden md:flex">
                            ...
                            ,&nbsp;
                            <a href="/confidentialite-et-cookies" class="underline hover:text-primary">Politique en matière de cookies</a>
                        </div>
