        ...
        <div class="w-full">
            ...
            <div class="flex flex-col w-full border-b-2 border-black p-3 gap-4">
                ...
                <div class="developped hidden flex items-center" id="developped-f7-tel">
                    <div class="flex items-center gap-2">
                        <input type="checkbox" class="mb-1" class="mb-1" id="gratuit-tel" name="gratuit-tel" />
                        <label>Gratuite</label>
                    </div>

                    <div class="flex items-center gap-2">
                        <input type="checkbox" class="mb-1" id="standard-tel" name="standard-tel" />
                        <label>Standard</label>
                    </div>

                    <div class="flex items-center gap-2">
                        <input type="checkbox" class="mb-1" id="premium-tel" name="premium-tel" />
                        <label>Premium</label>
                    </div>
                </div>
            </div>
