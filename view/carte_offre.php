					...
					<div class="flex gap-10 self-start items-center justify-center">
						...
						if ($est_en_ligne) {
							...
							<a href="/scripts/toggle_ligne.php?id_offre=<?php echo $id_offre ?>"
								...
								<svg id="wifi" class="toggle-wifi-offline p-1 duration-100 fill-currentColor hover:fill-[#EA4335]" width="55" height="40"
									viewBox="0 0 40 32">
									<path
							...
							?> title="[!!!] mettre en ligne">
								<svg id="wifi" class="toggle-wifi-online p-1 fill-[#EA4335] hover:fill-[#00350D] border-solid duration-300" width="55"
