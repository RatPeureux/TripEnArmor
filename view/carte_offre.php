					...
					<div class="flex gap-10 self-start items-center justify-center">
						...
						if ($est_en_ligne) {
							...
							<a href="/scripts/toggle_ligne.php?id_offre=<?php echo $id_offre ?>"
								...
								<svg id="wifi_to_offline" class="toggle-wifi-offline p-1 duration-100 fill-<?php if ($option) { echo 'white'; } else { echo 'primary'; } ?> hover:fill-[#EA4335]" width="55" height="40"
									viewBox="0 0 40 32">
									<path
