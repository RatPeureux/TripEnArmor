...
<div class="md:hidden h-full bg-base100 fixed top-0 w-7/12 left-0 -translate-x-full duration-200 z-50">
  ...
  <div class="all-items flex flex-col items-stretch">
    ...
    <a class="pl-5 py-3 border-t-2 border-black roundex-b-lg <?php if (isset($pagination) && $pagination == 3) {
      echo 'active';
...
<div class="hidden w-52 sticky top-2 md:block bg-white z-20 border-black border roundex-b-lg roundex-tr-lg">
  <a class="mt-4 mx-2 mb-1 self-end flex items-center gap-2">
      <i class="fa-solid fa-bars"></i>
      <p>Menu</p>
  </a>
  ...
  <div class="all-items flex flex-col items-stretch">
    ...
    <a class="pl-10 py-3 border-t-2 border-black roundex-b-lg <?php if (isset($pagination) && $pagination == 2) {
      echo 'active';
    } ?>" href="/offres">Toutes les offres</a>
    <!-- <a class="pl-10 py-3 border-t-2 border-black <?php if (isset($pagination) && $pagination == 4) {
      echo 'active';
