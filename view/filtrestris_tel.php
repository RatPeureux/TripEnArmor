...
<div class="block md:hidden p-4 h-16 w-full bg-blur/75 backdrop-blur border-t-2 border-black fixed bottom-0 flex items-center justify-between">
    ...
    <div>
        ...
        <div class="hidden md:hidden absolute bottom-[72px] right-2 z-20 bg-white border border-base200  shadow-md max-w-48 p-2 flex flex-col gap-4" id="sort-section-tel">
